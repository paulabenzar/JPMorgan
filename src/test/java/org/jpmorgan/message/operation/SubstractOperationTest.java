...
public class SubstractOperationTest {
    ...
    @InjectMocks
    private SubstractOperation sut;

    @Test
    public void testSubstractOperation() {
        SaleMessage sale = new SaleMessage("CD", 2, Price.buildGBPPrice(new BigDecimal("8")));
        ...
        assertEquals(OperationType.SUBSTRACT,  sale.getAdjustments().get(0).getOperationType());
    }
}
