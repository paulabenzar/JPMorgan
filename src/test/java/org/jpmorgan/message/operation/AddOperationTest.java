...
public class AddOperationTest {
    ...
    public void testAddOperation() {
        ...
        assertEquals(new BigDecimal("6"), sale.getAdjustments().get(0).getFinalValue().getValue());
        assertEquals(OperationType.ADD,  sale.getAdjustments().get(0).getOperationType());
    }
